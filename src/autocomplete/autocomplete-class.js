...
const { extend, id, nextTick, deleteProps, iosPreloaderContent, mdPreloaderContent } = Utils;
...
class Autocomplete extends Event {
  constructor(app, params = {}) {
    ...
    if (typeof defaults.searchbarDisableButton === 'undefined') {
      defaults.searchbarDisableButton = app.theme !== 'pc';
    }
  ...
  positionDropdown() {
    ...
    let $listParent;
    $listEl.parents().forEach((parentEl) => {
