/** @jsx jsx */
import {Utils, Event, jsx, Support as support, Device as device} from '@wiajs/core';

const { extend, nextTick, deleteProps } = Utils;
...
class Calendar extends Event {
  ...
  isPopover() {
    ...
    if (!calendar.inline && calendar.inputEl) {
      ...
      if (app.device.desktop && app.theme === 'pc') {
        return true;
      }
    }
    return false;
  ...
  update() {
    ...
    calendar.$months.forEach((monthEl) => {
