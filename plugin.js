...
module.exports = {
  install(less, pluginManager, functions) {
    ...
    functions.add('framework7_calculateN', n => new less.tree.Dimension(100 / parseFloat(n.value)));
      ...
      const iconsFontBase64 = ''; //base64Encode('./ui/f7/src/core/icons/font/framework7-core-icons.woff');
      return iconsFontBase64;
    });
    functions.add('framework7_skeletonFont', () => {
      const iconsFontBase64 = ''; //base64Encode('./ui/f7/src/core/icons/font/framework7-skeleton.woff');
      return iconsFontBase64;
    });
  },
};
